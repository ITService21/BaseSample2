      ...
      {menuLinks.map((link) => (
        ...
        >
          <Link
            ...
            className="relative group hover:text-gray-100 font-cinzel font-thin"
          >
            {link.name}
            {/* bg-[#20ff51] */}
            <span className="absolute left-0 bottom-[-3px] w-0 h-[2px] bg-[#ffffff] transition-all duration-200 group-hover:w-full "></span>
          </Link>
        </li>
      ))}
    </ul>
