  ...
  return (
    <section className="relative not-prose scroll-mt-[72px] text-white mt-[80px]" id="features">
        ...
        <div className="text-center md:mx-auto mb-8 md:mb-12 max-w-3xl">
            ...
            <h2 className="font-bold font-heading leading-tighter tracking-tighter text-heading md:text-4xl text-3xl">What You Get with [Institute_Name]</h2>
            <p className="text-xl mt-3 text-richblack-25 w-[90vw] mx-auto">[Institute_Name] offers a state-of-the-art platform for local students, designed with advanced features and a focus on providing an outstanding educational experience.</p>
        </div>
                    ...
                    <div key={index} className="flex flex-row max-w-md mx-auto w-[60vw]">
                        <div>
                            <span className="flex justify-center align-middle mr-4 -mt-[5px] bg-primary h-10 md:h-12 md:p-3 md:w-12 p-2 rounded-full text-white w-10">
                                <FontAwesomeIcon icon={item.icon} className="w-6 h-6 -mt-3 text-white bg-[#ff0088] p-3.5 rounded-full"/>
                            </span>
                        </div>
